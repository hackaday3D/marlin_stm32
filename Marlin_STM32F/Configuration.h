...
#define STRING_CONFIG_H_AUTHOR "(robert stm32, eryone config)" // Who made the changes.
...
//robert #define THERMAL_PROTECTION_HOTENDS // Enable thermal protection for all extruders
//robert #define THERMAL_PROTECTION_BED     // Enable thermal protection for the heated bed
