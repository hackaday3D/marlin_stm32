...
//#define ST7920_DELAY_3 DELAY_NS(0)
  ...
  #define CPU_ST7920_DELAY_2  DELAY_NS(20)
...
#define ST7920_WRITE_BYTE(a)     { ST7920_SWSPI_SND_8BIT((uint8_t)((a)&0xF0u)); ST7920_SWSPI_SND_8BIT((uint8_t)((a)<<4u)); u8g_Delay(5); /*U8G_DELAY();*/  }
